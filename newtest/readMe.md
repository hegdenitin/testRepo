...
cd inji-wallet/SampleCredentialWallet/SampleCredentialWallet
```
...
2. Click **File → Open**
3. Navigate to and select `SampleCredentialWallet/SampleCredentialWallet` directory
4. Click **OK** and wait for the project to load

### 3. Gradle Sync

Android Studio will automatically sync dependencies on project open. All dependencies are pre-configured in `app/build.gradle.kts`.
